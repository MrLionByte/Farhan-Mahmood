//Work Done by ND Space ,Farhan Mahmood N
//An upgraded version of my last project for IoT training programme
...
#include <DHT.h>
char auth[] = "Authorisation token from blink account";
char ssid[] = "wifi id";
...
int ledPin = 12;  //pin of 1st alarm
int inputPin = 13; //pin of 2nd alarm
int val = 0;
int Status =14; 
int sensor =3; 
#define IR D1
